...
$(warning *****KERNEL_OPPO_TARGET_DEVICE is $(OPPO_TARGET_DEVICE)****)
ifeq ($(OPPO_TARGET_DEVICE), oppo6771_18601)
KBUILD_CFLAGS   += -DTARGET_WATERMELON_Q_PROJECT
KBUILD_CPPFLAGS += -DTARGET_WATERMELON_Q_PROJECT
...
KBUILD_CFLAGS   += $(call cc-option,-Wnoerror=format)
